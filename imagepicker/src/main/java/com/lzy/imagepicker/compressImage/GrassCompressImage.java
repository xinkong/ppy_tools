package com.lzy.imagepicker.compressImage;
...
public class GrassCompressImage implements Handler.Callback {
  private static final String TAG = "GrassCompressImage";
  ...
  private GrassCompressImage(Builder builder) {
  ...
  public static class Builder {
    ...
    private GrassCompressImage build() {
      return new GrassCompressImage(this);
    }
